...
public class PenSerializer extends StdSerializer<JRPen>
{
	...
	{
		super((Class<JRPen>)null);
	}

	@Override
	public void serialize(JRPen value, JsonGenerator jgen, SerializerProvider provider) throws IOException 
	{
		jgen.writeObject(value);
	}
	
	@Override
	public boolean isEmpty(SerializerProvider provider, JRPen value) 
	{
		return !JRPenUtil.hasOwnValues(value);
	}
}
