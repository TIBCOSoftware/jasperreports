 ...
 */
public class JRMultipleSheetsXlsxSaveContributor extends JRSaveContributor
{
	 ...
	 * 
	 */
	public JRMultipleSheetsXlsxSaveContributor(
	...
	{
		return getBundleString("file.desc.xlsx.multiple.sheets");
	}
	...
	public static class Factory implements SaveContributorFactory
	{
		...
		public JRSaveContributor create(
			...
			ResourceBundle resBundle) 
		{
			return new JRMultipleSheetsXlsxSaveContributor(jasperReportsContext, locale, resBundle);
		}
	}
}
