 ...
 */
public class JRSingleSheetXlsxSaveContributor extends JRSaveContributor
{
	 ...
	 * 
	 */
	public JRSingleSheetXlsxSaveContributor(
	...
	{
		return getBundleString("file.desc.xlsx.single.sheet");
	}
