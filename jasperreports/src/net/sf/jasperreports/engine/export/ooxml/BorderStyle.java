...
public abstract class BorderStyle extends Style
{
	...
	protected void writeBorder(int side) throws IOException
	{
		...
		{
			styleWriter.write("       <w:" + border[side] +" w:val=\"" + borderStyle[side] + "\" w:sz=\"" + borderWidth[side] + "\" w:space=\"0\"	w:color=\"" + borderColor[side] + "\" /> \r\n");
		}
	}
	/**
	 *
	...
	protected void writePadding(int side) throws IOException
	{
		...
		{
			styleWriter.write("       <w:" + border[side] +" w:w=\"" + borderPadding[side] + "\" w:type=\"dxa\" /> \r\n");
		}
	}
