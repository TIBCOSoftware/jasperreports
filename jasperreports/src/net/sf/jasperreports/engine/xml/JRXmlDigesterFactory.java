...
//		digester.addSetNext("jasperReport/group/groupFooter", "setGroupFooter", JRSection.class.getName());
	...
	protected static void addTemplateRules(Digester digester)
	{
		...
		digester.addFactoryCreate(templatePattern, JRExpressionFactory.class);
...
//		 time series dataset
	...
	private static void addHyperlinkParameterRules(Digester digester)
	{
		...
		digester.addFactoryCreate(hyperlinkParameterExpressionPattern, JRExpressionFactory.class.getName());//FIXMENOW which is best? .class or .class.getName()
