...
public class JRApiWriter
{
	...
	protected void writeReport(Writer aWriter)
	{
		...
		write("import net.sf.jasperreports.engine.design.JRDesignBand;\n");
		write("import net.sf.jasperreports.engine.design.JRDesignExpression;\n");
		write("import net.sf.jasperreports.engine.design.JRDesignField;\n");
		write("import net.sf.jasperreports.engine.design.JRDesignFrame;\n");
		write("import net.sf.jasperreports.engine.design.JRDesignGroup;\n");
		write("import net.sf.jasperreports.engine.design.JRDesignLine;\n");
		write("import net.sf.jasperreports.engine.design.JRDesignParameter;\n");
		write("import net.sf.jasperreports.engine.design.JRDesignQuery;\n");
		write("import net.sf.jasperreports.engine.design.JRDesignStaticText;\n");
		write("import net.sf.jasperreports.engine.design.JRDesignStyle;\n");
		write("import net.sf.jasperreports.engine.design.JRDesignTextField;\n");
		write("import net.sf.jasperreports.engine.design.JRDesignVariable;\n");
		write("import net.sf.jasperreports.engine.design.JasperDesign;\n");
		write("\n");
		write("\n");
		...
		write("    jasperDesign.setName(\"" + report.getName() + "\");\n");
...
//		writer.addAttribute(JRXmlConstants.ATTRIBUTE_printOrder, report.getPrintOrder(), JRXmlConstants.getPrintOrderMap(), JRReport.PRINT_ORDER_VERTICAL);
		write("    jasperDesign.setPageWidth(595);\n");
		write("    jasperDesign.setPageHeight(842);\n");
