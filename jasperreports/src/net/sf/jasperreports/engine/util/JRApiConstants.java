	...
	*/
	...
	public static Map getHorizontalAlignMap()
	{
		if (horizontalAlignMap == null)
		{
			...
			map.put(new Byte(JRAlignment.HORIZONTAL_ALIGN_LEFT),      "JRAlignment.HORIZONTAL_ALIGN_LEFT");
			map.put(new Byte(JRAlignment.HORIZONTAL_ALIGN_CENTER),    "JRAlignment.HORIZONTAL_ALIGN_CENTER");
			map.put(new Byte(JRAlignment.HORIZONTAL_ALIGN_RIGHT),     "JRAlignment.HORIZONTAL_ALIGN_RIGHT");
			map.put(new Byte(JRAlignment.HORIZONTAL_ALIGN_JUSTIFIED), "JRAlignment.HORIZONTAL_ALIGN_JUSTIFIED");
	...
	public static String getHorizontalAlign(Byte key)
	{
		return (String)getHorizontalAlignMap().get(key);
	}
	...
	public static String getTextAlign(Byte key)
	{
		return getHorizontalAlign(key);
	}
	...
	public static Map getVerticalAlignMap()
	{
		...
		{
			Map map = new HashMap(8);
			map.put(new Byte(JRAlignment.VERTICAL_ALIGN_TOP),    "JRAlignment.VERTICAL_ALIGN_TOP");
			map.put(new Byte(JRAlignment.VERTICAL_ALIGN_MIDDLE), "JRAlignment.VERTICAL_ALIGN_MIDDLE");
			map.put(new Byte(JRAlignment.VERTICAL_ALIGN_BOTTOM), "JRAlignment.VERTICAL_ALIGN_BOTTOM");
	...
	public static String getVerticalAlign(Byte key)
	{
		return (String)getVerticalAlignMap().get(key);
	}
