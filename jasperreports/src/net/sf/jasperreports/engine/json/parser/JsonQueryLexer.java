...
public JsonQueryLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("true", this), new Integer(42));
	literals.put(new ANTLRHashString("false", this), new Integer(43));
}
...
tryAgain:
	...
	public final void mBACKSP(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = BACKSP;
		int _saveIndex;
