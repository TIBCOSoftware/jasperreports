...
public class JRSingleSheetXlsSaveContributorFactory implements JRSaveContributorFactory {

	@Override
	public JRSaveContributor create(JasperReportsContext jasperReportsContext, Locale locale,
			ResourceBundle resBundle) {
		return new JRSingleSheetXlsSaveContributor(jasperReportsContext, locale, resBundle);
	}
