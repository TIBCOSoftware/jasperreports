 ...
 */
public class HttpRepositoryPersistenceServiceFactory implements PersistenceServiceFactory
{
	private static final HttpRepositoryPersistenceServiceFactory INSTANCE = new HttpRepositoryPersistenceServiceFactory();
	
	/**
	 * 
	 */
	public static HttpRepositoryPersistenceServiceFactory getInstance()
	{
		return INSTANCE;
	}
	...
	{
		if (HttpRepositoryService.class.isAssignableFrom(repositoryServiceType))
		{
