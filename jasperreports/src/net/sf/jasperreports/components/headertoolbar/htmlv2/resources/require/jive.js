define(["jquery", "jqueryui", "jquerytimepicker", "jasperreports", "reportviewertoolbar", "jivei18n"], 
	function(jQuery, jUi, jTP, jasperreports, reportviewertoolbar, jivei18n) {
	...
	var jive = {
		...
		init:function(settings){
	        ...
	        jQuery('table.jrPage').parent().on('click touchend',function(){
	    ...
	    initInteractiveElement: function(o){
	        if(jive.elements[o.id]) {
	             ...
	             * listeners.
	             */
	            if(typeof jQuery('table.jrPage').data('events') === 'undefined') {
	                jive.selectors = {};
	            }
	        }
	...
	jive.ui.modal = {
	    ...
	    show: function(whoHasFocus) {
	        ...
	        if(jQuery('#jive_modal').length == 0) {
	            jQuery('table.jrPage').parent().append('<div id="jive_modal" style="display:none;position:absolute;z-index:9999;top:0;bottom:0;left:0;right:0;"></div>');
