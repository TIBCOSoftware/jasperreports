...
public class JRFillMultiAxisPlot extends JRFillChartPlot implements JRMultiAxisPlot
{
    ...
    public JRFillMultiAxisPlot(JRMultiAxisPlot multiAxisPlot, JRFillObjectFactory factory)
    {
        ...
        Iterator iter = multiAxisPlot.getAxes().iterator();
        while (iter.hasNext())
        {
    ...
    public List getAxes()
    {
        return ((JRMultiAxisPlot)parent).getAxes();
    }

    public JRFillChartDataset getMainDataset()
    {
    	return (JRFillChartDataset)((JRChartAxis)((JRMultiAxisPlot)parent).getAxes().get(0)).getFillChart().getDataset();
    }
}
