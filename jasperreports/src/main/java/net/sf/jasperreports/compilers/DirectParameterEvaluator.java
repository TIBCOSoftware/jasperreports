...
public class DirectParameterEvaluator extends UniformExpressionEvaluator
{
	...
	public DirectParameterEvaluator(JRFillParameter parameter, DirectExpressionValueFilter valueFilter)
	{
	...
	{
		return valueFilter.filterValue(parameter.getValue(), parameter.getValueClass());
	}
