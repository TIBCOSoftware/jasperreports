...
public class JRFillLinePlot extends JRFillChartPlot implements JRLinePlot 
{
	 ...
	 *
	 */
	public JRFillLinePlot( JRLinePlot plot, ChartsFillObjectFactory factory )
	{
		super( plot, factory );

		JRFillObjectFactory parentFactory = factory.getParent();

		categoryAxisLabelFont = parentFactory.getFont(plot.getChart(), plot.getCategoryAxisLabelFont()); 
		categoryAxisLabelColor = plot.getOwnCategoryAxisLabelColor();
		categoryAxisTickLabelFont = parentFactory.getFont(plot.getChart(), plot.getCategoryAxisTickLabelFont());
		categoryAxisTickLabelColor = plot.getOwnCategoryAxisTickLabelColor();
		categoryAxisLineColor = plot.getOwnCategoryAxisLineColor();
		
		valueAxisLabelFont = parentFactory.getFont(plot.getChart(), plot.getValueAxisLabelFont());
		valueAxisLabelColor = plot.getOwnValueAxisLabelColor();
		valueAxisTickLabelFont = parentFactory.getFont(plot.getChart(), plot.getValueAxisTickLabelFont());
