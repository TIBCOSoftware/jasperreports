...
public class JRBaseCategorySeries implements JRCategorySeries, Serializable
{
	...
	public JRBaseCategorySeries(JRCategorySeries categorySeries, ChartsBaseObjectFactory factory)
	{
		...
		parentFactory.put(categorySeries, this);

		seriesExpression = parentFactory.getExpression(categorySeries.getSeriesExpression());
		categoryExpression = parentFactory.getExpression(categorySeries.getCategoryExpression());
		valueExpression = parentFactory.getExpression(categorySeries.getValueExpression());
		labelExpression = parentFactory.getExpression(categorySeries.getLabelExpression());
		itemHyperlink = parentFactory.getHyperlink(categorySeries.getItemHyperlink());
	}
