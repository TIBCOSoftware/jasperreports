...
public class BookApp extends AbstractSampleApp
{
	...
	public void pdf() throws JRException
	{
		...
		exporter.setExporterInput(new SimpleExporterInput("target/reports/BookReport.jrprint"));
		exporter.setExporterOutput(new SimpleOutputStreamExporterOutput("target/reports/BookReport.pdf"));
	...
	{
		long start = System.currentTimeMillis();
		File sourceFile = new File("target/reports/BookReport.jrprint");
