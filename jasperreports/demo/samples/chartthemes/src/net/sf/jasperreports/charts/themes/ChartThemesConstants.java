...
public interface ChartThemesConstants
{
	...
	public static final String DEFAULT_RANGE_AXIS_TICK_COUNT = "defaultRangeAxisTickCount";
	...
	public static final String DEFAULT_DOMAIN_AXIS_TICK_COUNT = "defaultDomainAxisTickCount";
