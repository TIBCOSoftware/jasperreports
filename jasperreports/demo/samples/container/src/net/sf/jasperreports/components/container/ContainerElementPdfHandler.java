 ...
 */
public class ContainerElementPdfHandler implements GenericElementPdfHandler
{
	...
	public void exportElement(JRPdfExporterContext exporterContext, JRGenericPrintElement element)
	{
		...
		JRPrintText printText = (JRPrintText)element.getParameterValue(ContainerElement.PARAMETER_PRINT_TEXT_ELEMENT);
...
//        }
        ...
        if (Boolean.TRUE.equals(element.getParameterValue(ContainerElement.PARAMETER_MULTI_LINE)))
        {
