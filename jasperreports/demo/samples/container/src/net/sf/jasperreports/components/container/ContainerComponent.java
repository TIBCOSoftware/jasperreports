 ...
 */
public class ContainerComponent implements ContextAwareComponent, Serializable, JRChangeEventsSupport {
	...
	public ContainerComponent(JRDefaultStyleProvider defaultStyleProvider) 
	{
		textField = new JRDesignTextField(defaultStyleProvider);
	}
	
	public ContainerComponent(ContainerComponent component, JRBaseObjectFactory objectFactory) 
	{
