...
public interface ContainerElement 
{
	...
	public static final JRGenericElementType CONTAINER_ELEMENT_TYPE = new JRGenericElementType(ContainerElementHandlerBundle.NAMESPACE, CONTAINER_ELEMENT_NAME);
