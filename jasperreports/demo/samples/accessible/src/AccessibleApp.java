...
public class AccessibleApp extends AbstractSampleApp
{
	...
	public void fill() throws JRException
	{
		...
		JasperFillManager.fillReportToFile("build/reports/AccessibleReport.jasper", parameters);
	...
	{
		long start = System.currentTimeMillis();
		JasperPrintManager.printReport("build/reports/AccessibleReport.jrprint", true);
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToPdfFile("build/reports/AccessibleReport.jrprint");
	...
	public void pdfa1() throws JRException
	{
		...
		try{
			...
			JasperPrint jp = (JasperPrint)JRLoader.loadObject(new File("build/reports/AccessibleReport.jrprint"));
...
//			configuration.setIccProfilePath("path/to/ICC/profile");
			...
			FileOutputStream fos = new FileOutputStream("build/reports/AccessibleReport_pdfa.pdf");
			os.writeTo(fos);
			fos.close();
		}catch(Exception e){
			 e.printStackTrace();
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToXmlFile("build/reports/AccessibleReport.jrprint", false);
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToXmlFile("build/reports/AccessibleReport.jrprint", true);
		System.err.println("XML creation time : " + (System.currentTimeMillis() - start));
	}
	...
	{
		long start = System.currentTimeMillis();
		JasperExportManager.exportReportToHtmlFile("build/reports/AccessibleReport.jrprint");
	...
	public void run() throws JRException
	{
		...
		JasperRunManager.runReportToPdfFile("build/reports/AccessibleReport.jasper", parameters, getDemoHsqldbConnection());
