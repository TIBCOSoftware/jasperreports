...
public class GraphicStyle extends Style
{
	 ...
	 *
	 */
	public GraphicStyle(Writer bodyWriter, JRPrintGraphicElement element)
	{
		super(null, bodyWriter);
	...
	{
		bodyWriter.write(" <style:style style:name=\"" + lineStyleName + "\"");
		bodyWriter.write(" style:family=\"graphic\" style:parent-style-name=\"Graphics\">\n");
		bodyWriter.write("   <style:graphic-properties");
		bodyWriter.write(" draw:fill-color=\"#" + backcolor + "\"");
		bodyWriter.write(" style:horizontal-pos=\""+hAlign+ "\" style:horizontal-rel=\"paragraph\"");
		bodyWriter.write(" style:vertical-pos=\""+vAlign+ "\" style:vertical-rel=\"paragraph\"");
		bodyWriter.write(" svg:stroke-color=\"#" + forecolor + "\"");
		bodyWriter.write(" draw:stroke=\"" + style + "\"");//FIXMENOW dashed borders do not work; only dashed lines and ellipses seem to work
		bodyWriter.write(" draw:stroke-dash=\"Dashed\"");
		bodyWriter.write(" svg:stroke-width=\"" + width + "in\"");
		bodyWriter.write("/>\n");
		bodyWriter.write("</style:style>\n");
	}
