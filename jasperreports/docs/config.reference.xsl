...
<xsl:template match="dd">
  <span class="fnt11 gr1"><xsl:element name="dd"><xsl:apply-templates/></xsl:element></span>
</xsl:template>
...
<xsl:template match="simpleType/restriction/enumeration">
  <xsl:apply-templates select="restriction/enumeration"/>
</xsl:template>


<xsl:template match="simpleType[@name='basicEvaluationTime']">
  <xsl:apply-templates select="restriction/enumeration"/>
</xsl:template>


<xsl:template match="simpleType[@name='complexEvaluationTime']">
  <xsl:apply-templates select="restriction/enumeration"/>
</xsl:template>
...
<xsl:template match="restriction/enumeration">
  <tr valign="top">
    ...
    <td><xsl:if test="annotation/documentation and annotation/documentation[.!='']"><span class="fnt11 gr1"><xsl:value-of select="annotation/documentation"/></span></xsl:if></td>
  </tr>
</xsl:template-->
