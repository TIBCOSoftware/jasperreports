...
<br/>
<span class="element"><xsl:element name="a"><xsl:attribute name="href">https://github.com/TIBCOSoftware/jasperreports/tree/<xsl:value-of select="$scm-tag"/>/jasperreports/demo/samples/<xsl:value-of select="sample/name"/>/</xsl:attribute><xsl:attribute name="target">_blank</xsl:attribute>Browse Sample Source Files on Git</xsl:element></span>
