...
import net.sf.jasperreports.interactivity.headertoolbar.actions.ResizeColumnCommand.ColumnGroupInfo;
import net.sf.jasperreports.interactivity.headertoolbar.actions.ResizeColumnCommand.ColumnUtil;
