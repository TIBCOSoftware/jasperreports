...
public class DataAdapterRepositoryExtensionRegistry implements ExtensionsRegistry
{
	...
	{
		if (PersistenceServiceFactory.class.equals(extensionType))
		{
			return (List<T>) Collections.singletonList(DataAdapterDefaultRepositoryPersistenceServiceFactory.getInstance());
		}
		return null;
	}
}
