...
import net.sf.jasperreports.charts.xml.ChartFontFactory;
...
public class SpiderChartDigester implements XmlDigesterConfigurer
{
	...
	public static void addSpiderChartRules(Digester digester)
	{
		...
		digester.addFactoryCreate(chartTitlePattern + "/font", ChartFontFactory.class.getName());
		...
		digester.addFactoryCreate(chartSubtitlePattern + "/font", ChartFontFactory.class.getName());
		...
		digester.addFactoryCreate(chartSettingsPattern + "/chartLegend/font", ChartFontFactory.class.getName());
		...
		digester.addFactoryCreate(labelFontPattern, ChartFontFactory.class.getName());
