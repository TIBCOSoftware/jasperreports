...
public class ChartTemplateImage extends JRTemplateImage
{
	 ...
	 *
	 */
	protected ChartTemplateImage(JROrigin origin, JRDefaultStyleProvider defaultStyleProvider, JRImage image)
	{
	 ...
	 * this template
	 */
	public ChartTemplateImage(JROrigin origin, JRDefaultStyleProvider defaultStyleProvider)
	{
		super(origin, defaultStyleProvider);
	...
	public boolean isIdentical(Object object)
	{
		...
		if (!(object instanceof ChartTemplateImage))
		{
			return false;
		}
