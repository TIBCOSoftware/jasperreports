...
/**
 * Utility class that creates generic print elements of bridge type.
 * 
 * @author Giulio Toffoli (gtoffoli@tibco.com)
 */
public final class BridgePrintElement
{
    
        public static final String PARAMETER_ON_ERROR_TYPE = BridgeConstants.PROPERTY_ON_ERROR_TYPE;
	/**
	 * The qualified type of the Bridge generic elements. 
	 */
	public static final JRGenericElementType BRIDGE_ELEMENT_TYPE = 
		new JRGenericElementType(BridgeConstants.NAMESPACE, BridgeConstants.COMPONENT_NAME);
