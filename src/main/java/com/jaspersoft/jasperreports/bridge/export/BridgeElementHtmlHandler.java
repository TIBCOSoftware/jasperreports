...
public class BridgeElementHtmlHandler implements GenericElementHtmlHandler
{
	private static final BridgeElementHtmlHandler INSTANCE = new BridgeElementHtmlHandler();
        private static final Log log = LogFactory.getLog(BridgeElementHtmlHandler.class);
        
        private static final String BRIDGE_COMPONENT_SCRIPTS_HANDLER = "bridge_component_script_handler";
        private static final String BRIDGE_COMPONENT_FIRST_ATTEMPT = "bridge_component_first_attempt";
        private static final String VELOCITY_TEMPLATE = "com/jaspersoft/jasperreports/bridge/templates/defaultTemplate.vm";
	
	public static BridgeElementHtmlHandler getInstance()
	{
		return INSTANCE;
	}
	...
	public String getHtmlFragment(JasperReportsContext jrContext, JRHtmlExporterContext context, JRGenericPrintElement element)
	{
            ...
            try {
                ...
                {
                    BridgeElementJsonHandler.cleanConfigurationForJSON(configuration);
