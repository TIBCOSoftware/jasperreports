 ...
 */
public class BridgeElementOdsHandler implements GenericElementOdsHandler {
	
	private static final BridgeElementOdsHandler INSTANCE = new BridgeElementOdsHandler();
	private static final Log log = LogFactory.getLog(BridgeElementOdsHandler.class);
	
        
        public static BridgeElementOdsHandler getInstance()
	{
		return INSTANCE;
	}
