 ...
 * @version $Id: BridgeDesignItemProperty.java 6002 2013-03-20 08:15:32Z teodord $
 */
public class BridgeDesignItemProperty implements BridgeItemProperty, JRChangeEventsSupport, Serializable
{
	...
	public BridgeDesignItemProperty()
	{
	}
	
	public BridgeDesignItemProperty(String name, String value, JRExpression valueExpression)
	{
		this.name = name;
	...
	public Object clone()
	{
		try
		{
			BridgeDesignItemProperty clone = (BridgeDesignItemProperty) super.clone();
