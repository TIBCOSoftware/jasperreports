    ...
    extends TestCase
{
    ...
    static final String SCRIPT_PROPERTY_PREFIX = "com.jaspersoft.jasperreports.components.bridge.script.path.";
     ...
     */
    public BridgeComponentTest( String testName )
    {
        super( testName );
    ...
    {
        return new TestSuite( BridgeComponentTest.class );
    }
