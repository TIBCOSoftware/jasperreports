define(['jquerytimepicker', 'jasperreports-event-manager', 'text!jive.templates.tmpl', 'text!jive.vm.css'], function($, EventManager, templates, css) {
    var jive = {
        ...
        elements: {},
        interactive:{},
        reportContainer: $('table.jrPage').closest('div'),
        i18n: {
            keys: {
                'column.format.dialog.title': "Format column",
                'column.format.title': "Column options",
                'column.format.formatmenu.label': "Formatting...",
                'column.format.hidecolumn.label': "Hide column",
                'column.format.showcolumns.label': "Show columns &#x25ba;",
                'column.format.showcolumns.all.label': "&lt;All&gt;",

                'column.filter.dialog.title': "Filter column",
                'column.filter.title': "Column filters",
                'column.sortasc.title': "Sort ascending",
                'column.sortdesc.title': "Sort descending",

                'column.dialog.extfonts': "Extension fonts",
                'column.dialog.sysfonts': "System fonts",

                'column.filterform.clearfilter.true.label': "Show all rows",
                'column.filterform.clearfilter.false.label': "Show only rows where",

                'column.formatHeaderForm.title': "Headings",
                'column.formatHeaderForm.headingName.label': "Heading text",

                'column.formatforms.fontName.label': "Font",
                'column.formatforms.fontSize.label': "Size",
                'column.formatforms.fontColor.title': "Pick a font color",
                'column.formatforms.fontBackColor.title': "Pick a background color",
                'column.formatforms.styleButtons.label': "Style",
                'column.formatforms.color.label': "Color",
                'column.formatforms.alignment.label': "Alignment",
                'column.formatforms.numberformat.label': "Number format",
                'column.formatforms.currency.label': "Currency",
                'column.formatforms.currency.none.label': "&lt;None&gt;",

                'column.formatCellsForm.title': "Values",
                'column.formatCellsForm.formatPattern.label': "Format pattern",
                'column.formatCellsForm.numberFormatButtons.localespecific.label': "¤ - Locale specific",

                'column.move.helper': "Drag to new column position",

                'column.conditionalFormatting.title': "Conditional Formatting",
                'column.conditionalFormatting.conditions.list.title': "Conditions List",
                'column.conditionalFormatting.condition.operator': "Operator",
                'column.conditionalFormatting.condition.condition': "Condition",
                'column.conditionalFormatting.condition.format': "Format",
                'column.conditionalFormatting.condition.add': "Add"
            },
            get: function (key) {
        ...
        initInteractiveElement: function(o){
            if(jive.elements[o.config.id]) {
                 ...
                 * listeners.
                 */
                if(typeof $('table.jrPage').data('events') === 'undefined') {
                    jive.selectors = {};
                }
            }
