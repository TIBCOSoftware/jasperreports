 ...
 */
public class PDFiTextBreakIteratorSplitCharacter implements SplitCharacter
{
	...
	public PDFiTextBreakIteratorSplitCharacter()
	{
		this(BreakIterator.getLineInstance());
	}
	
	public PDFiTextBreakIteratorSplitCharacter(BreakIterator breakIter)
	{
