...
public class JRXmlDigesterFactory
{
	...
	public static void configureDigester(Digester digester) throws SAXException, ParserConfigurationException
	{
		...
		digester.addFactoryCreate("jasperReport/group/groupHeader", JRSectionFactory.class.getName());
		...
		digester.addFactoryCreate("jasperReport/detail", JRSectionFactory.class.getName());
		...
		digester.addFactoryCreate("jasperReport/group/groupFooter", JRSectionFactory.class.getName());
