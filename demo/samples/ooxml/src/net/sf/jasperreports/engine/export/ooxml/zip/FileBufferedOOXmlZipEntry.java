 ...
 * @version $Id$
 */
public class FileBufferedOOXmlZipEntry implements OOXmlZipEntry 
{
	/**
	 * 
	 */
	 ...
	 * 
	 */
	public FileBufferedOOXmlZipEntry(String name)
	{
		this(name, null);
	}
	 ...
	 * 
	 */
	public FileBufferedOOXmlZipEntry(String name, byte[] bytes)
	{
		this.name = name;
