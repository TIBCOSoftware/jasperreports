...
/**
 * Exports a JasperReports document to Open Office Xml Excel format. It has character output type
 * and exports the document to a grid-based layout.
 *
 * @author sanda zaharia (shertage@users.sourceforge.net)
 * @version $Id$
 */
public class JRXlsxExporter extends JROpenOfficeXmlExporter
{

	public JRXlsxExporter()
	{
		super();
		exporterPropertiesPrefix = JROpenOfficeXmlExporter.XLSX_EXPORTER_PROPERTIES_PREFIX;
	}
	...
	protected ExporterNature getExporterNature(ExporterFilter filter) {
		return new JRXlsxExporterNature(filter);
	}
}
