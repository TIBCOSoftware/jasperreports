...
/**
 * Exports a JasperReports document to Open Office Xml Word format. It has character output type and exports the document to a
 * grid-based layout.
 * @author sanda zaharia (shertage@users.sourceforge.net)
 * @version $Id$
 */
public class JRDocxExporter extends JROpenOfficeXmlExporter
{

	public JRDocxExporter()
	{
		super();
		exporterPropertiesPrefix = JROpenOfficeXmlExporter.DOCX_EXPORTER_PROPERTIES_PREFIX;
	}
