...
import net.sf.jasperreports.engine.export.ooxml.zip.FileBufferedOOXmlZipEntry;
 ...
 * @version $Id$
 */
public class JRDocxFrameExporter extends JRAbstractExporter
{
	...
	protected void exportReportToOOXmlZip(OutputStream os) throws JRException, IOException
	{
		...
		OOXmlZipEntry tempBodyEntry = new FileBufferedOOXmlZipEntry(null);
		OOXmlZipEntry tempStyleEntry = new FileBufferedOOXmlZipEntry(null);
...
//				JROpenOfficeXmlExporterNature.DOCX_NATURE
//				);
