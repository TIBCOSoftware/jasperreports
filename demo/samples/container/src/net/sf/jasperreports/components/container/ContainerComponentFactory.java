 ...
 */
public class ContainerComponentFactory extends JRBaseFactory
{
	...
	public Object createObject(Attributes atts)
	{
		...
		ContainerComponent containerComponent = new ContainerComponent(jasperDesign);

//		String isMultiLine = atts.getValue(JRXmlConstants.ATTRIBUTE_multiLine);
//		if (isMultiLine != null && isMultiLine.length() > 0)
//		{
//			containerComponent.setMultiLine(Boolean.valueOf(isMultiLine).booleanValue());
//		}
