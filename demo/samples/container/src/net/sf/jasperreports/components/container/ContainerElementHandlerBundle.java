 ...
 * @version $Id: TextInputElementHandlerBundle.java 5921 2013-02-19 10:23:06Z teodord $
 */
public final class ContainerElementHandlerBundle implements GenericElementHandlerBundle
{
	public static final String NAMESPACE = "http://jasperreports.sourceforge.net/jasperreports/container";
	
	private static final ContainerElementHandlerBundle INSTANCE = new ContainerElementHandlerBundle();
	
	public static ContainerElementHandlerBundle getInstance()
	{
		return INSTANCE;
	}
...
//		else if (NAME.equals(elementName)
		if (ContainerElement.CONTAINER_ELEMENT_NAME.equals(elementName)
				&& JRPdfExporter.PDF_EXPORTER_KEY.equals(exporterKey))
		{
			return new ContainerElementPdfHandler();
		}
//		else if (NAME.equals(elementName)
