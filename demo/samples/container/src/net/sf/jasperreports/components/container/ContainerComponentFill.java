 ...
 */
public class ContainerComponentFill extends BaseFillComponent {
	...
	public ContainerComponentFill(ContainerComponent containerComponent, JRFillObjectFactory factory)
	{
		this.containerComponent = containerComponent;
		this.textField = (JRFillTextField)factory.getVisitResult(containerComponent.getTextField());
	}
	
	public ContainerComponentFill(ContainerComponent containerComponent, JRFillCloneFactory factory)
	{
		this.containerComponent = containerComponent;
		this.textField = null;//FIXMEINPUT (JRFillTextField)factory.getVisitResult(containerComponent.getTextField());
	}
	...
	public FillPrepareResult prepare(int availableHeight)
	{
		...
		if (template == null) 
		{
			template = new JRTemplateGenericElement(
					...
					ContainerElement.CONTAINER_ELEMENT_TYPE);
		
			template.setMode(containerComponent.getContext().getComponentElement().getModeValue());
			template.setBackcolor(containerComponent.getContext().getComponentElement().getBackcolor());
			template.setForecolor(containerComponent.getContext().getComponentElement().getForecolor());
		...
		printElement.setParameterValue(ContainerElement.PARAMETER_MULTI_LINE, containerComponent.isMultiLine());
...
//		copy(printElement);
	...
	{
		printElement.setParameterValue(ContainerElement.PARAMETER_PRINT_TEXT_ELEMENT, printText);//FIXMEINPUT
