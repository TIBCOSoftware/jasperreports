 ...
 */
public class ContainerComponentDesignConverter extends ElementIconConverter implements ComponentDesignConverter
{

	/**
	 *
	 */
	private final static ContainerComponentDesignConverter INSTANCE = new ContainerComponentDesignConverter();
	
	/**
	 *
	 */
	private ContainerComponentDesignConverter()
	{
	 ...
	 *
	 */
	public static ContainerComponentDesignConverter getInstance()
	{
		return INSTANCE;
	}
