 ...
 */
public class ContainerTextFieldFactory extends JRTextFieldFactory
{
	...
	{
		ContainerComponent containerComponent = (ContainerComponent)digester.peek();
		JRDesignTextField textField = (JRDesignTextField)containerComponent.getTextField();
		return textField;
	}
